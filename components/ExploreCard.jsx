...
const ExploreCard = ({ id, imgUrl, title, index, active, handleClick }) => (
  ...
  >
    ...
    { active !== id ? (
      ...
      <div className="absolute bottom-0 p-8 justify-start w-full max-h-[70%] flex-col bg-[rgba(0,0,0,0.5)] rounded-b-[24px]">
        ...
        <p className="font-normal text-[16px] leading-[20.16px] text-white uppercase">Tận hưởng ngay</p>
